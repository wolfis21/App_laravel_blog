...
@section('content')
    ...
    <div class="bg-gray-600 px-20 py-20 rounded-lg mb-8 relative overflow-hidden">
            ...
            @foreach ($posts as $post)
                <a href="{{ route('post', $post->slug)}}" class="bg-gray-100 rounded-lg px-6 py-4">
                    <p class="text-xs flex items-center gap-2">
                        <span class="uppercase text-gray-700 bg-gray-200 rounded-full px-2">Tutorial</span>
